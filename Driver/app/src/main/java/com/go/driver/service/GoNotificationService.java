...
public class GoNotificationService extends FirebaseMessagingService {
    ...
    public void onMessageReceived(RemoteMessage remoteMessage) {
        ...
        if(data.containsKey(NotificationHelper.DATA_KEY)){
            sentTripRequest(data);
        }
        else {
            showNotification(data.get(NotificationHelper.TITLE_KEY), data.get(NotificationHelper.MESSAGE_KEY), null);
        }
    }
